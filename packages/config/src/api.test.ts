...
describe("api configuration: field validation", () => {
  ...
  it.each([
    ...
    ["TRIGGER_SECRET_KEY", "sk_live_abcdefgh", "Trigger.dev environment secret key"],
    ["TRIGGER_SECRET_KEY", "tr_pat_abcdefghijklmnop", "not a personal access token"],
    ["POSTHOG_PROJECT_KEY", "phx_abcdefghijklmnopqrstuvwx", "PostHog project ingest key"],
    ["POSTHOG_PROJECT_KEY", "abcdefghijklmnopqrstuvwx", "PostHog project ingest key"],
