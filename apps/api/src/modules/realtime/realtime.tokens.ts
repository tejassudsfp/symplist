...
export interface RealtimeDependencies {
  ...
  /** Resolves the session cookie of an upgrade (the core access session service). */
  readonly sessions: WsSessionResolver;
  /** The core access service's guard-level check. */
...
/** The gateway's `AccessPostCommitHook` (§5.1, §5.5). */
export const REALTIME_POST_COMMIT_HOOK = "symplist:realtime-post-commit-hook";
